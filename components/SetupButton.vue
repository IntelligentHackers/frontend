...
<template>
    ...
    >
      <button
        ...
        :class="
          cn(
            `flex justify-center items-center h-12 w-full border-none bg-gray-50 dark:bg-zinc-800 text-black dark:text-white shadow-input rounded-md px-3 py-2 text-base file:border-0 file:bg-transparent 
